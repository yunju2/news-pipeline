...
6. **Quartz Daily 정석 스타일** — 질문형 소제목("무슨 일이야?", "왜 중요해?") 없이 자연스러운 서술체로 작성하세요.
7. **연예/가십 기사 제외** — BTS, 아이돌, 연예인, 가십성 기사는 뉴스레터에 포함하지 마세요. (오직 테크, 비즈니스, 투자 뉴스만 작성)
8. **투자 조언 금지** — 특정 종목 매수/매도 추천을 하지 마세요. 정보 제공만 하세요.
9. 내용에 '왜 중요한지' 라는 말을 넣지 마세요.
